...
pub unsafe fn clamp_i16(val: VecI16, min: VecI16, max: VecI16) -> VecI16 {
    unsafe { _mm512_min_epi16(max, _mm512_max_epi16(val, min)) }
}
#[inline(always)]
...
pub unsafe fn fmadd_i16(sum: VecI32, a: VecI16, b: VecI16) -> VecI32 {
    unsafe { _mm512_dpwssd_epi32(sum, a, b) }
}
#[cfg(simd_avx512f)]
#[inline(always)]
pub unsafe fn fmadd_i16(sum: VecI32, a: VecI16, b: VecI16) -> VecI32 {
    unsafe { _mm512_add_epi32(sum, _mm512_madd_epi16(a, b)) }
}
...
pub unsafe fn hsum_i32(val: VecI32) -> i32 {
    unsafe { _mm512_reduce_add_epi32(val) }
}
