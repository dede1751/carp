...
pub const ACC: usize = 4; // number of accumuators to use for unrolling
...
pub unsafe fn load_i16<const N: usize>(ptr: *const i16) -> [VecI16; N] {
    array::from_fn(|i| _mm256_load_si256(ptr.add(i * VEC_I16_SIZE)))
}
#[inline(always)]
...
pub unsafe fn fmadd_i16<const N: usize>(
    ...
    let prod_32 = array::from_fn(|i| _mm256_madd_epi16(a[i], b[i]));
